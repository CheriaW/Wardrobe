...
namespace BasicClosetMVC.Controllers
{
    public class OccassionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccassionsID,OccassionName")] Occassion occassion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccassionsID,OccassionName")] Occassion occassion)
        {
            if (ModelState.IsValid)
            {
